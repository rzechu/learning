// init_config_rs.js
// This script initializes the config server replica set.
// It will only run if the replica set is not already initialized.
...
try {
    rs.status(); // Check if replica set is already initialized
